            ...
            <div class="col-md-9" style="border-left:1px solid #eaeaea;">
                <form method="post" action="php/doedit.php?id=<?php echo $row['u_id'] ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="column">
                            <option <?php if ($row['u_column'] == 'Web前端开发')
                                echo 'selected'; ?>>
                                Web前端开发
                            </option>
                            <option <?php if ($row['u_column'] == 'UI设计')
                                echo 'selected'; ?>>
                                UI设计
                            </option>
                            <option <?php if ($row['u_column'] == 'PHP开发')
                                echo 'selected'; ?>>
                                PHP开发
                            </option>
                            <option <?php if ($row['u_column'] == 'JAVA开发')
                                echo 'selected'; ?>>
                                JAVA开发
                            </option>
                            <option <?php if ($row['u_column'] == '网络营销')
                                echo 'selected'; ?>>
                                网络营销
                            </option>
                        </select>
