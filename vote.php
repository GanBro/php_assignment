        ...
        <div class="voteWrap">
            ...
            <div class="progress">
                <div id="vote0" class="progress-bar progress-bar-striped active" role="progressbar"
                    aria-valuenow="<?php echo round($fileArr[0] / $sum * 100); ?>" aria-valuemin="0" aria-valuemax="100"
                    style="width: <?php echo round($fileArr[0] / $sum * 100); ?>%">
                    <?php echo round($fileArr[0] / $sum * 100); ?>%
                </div>
            </div>
            <h4>移动端网站重构（<span>
            ...
            <div class="progress">
                <div class="progress-bar progress-bar-striped active" role="progressbar"
                    aria-valuenow="<?php echo round($fileArr[1] / $sum * 100); ?>" aria-valuemin="0" aria-valuemax="100"
                    style="width: <?php echo round($fileArr[1] / $sum * 100); ?>%">
                    <?php echo round($fileArr[1] / $sum * 100); ?>%
                </div>
            </div>
            <h4>JavaScript（<span>
            ...
            <div class="progress">
                <div class="progress-bar progress-bar-striped active" role="progressbar"
                    aria-valuenow="<?php echo round($fileArr[2] / $sum * 100); ?>" aria-valuemin="0" aria-valuemax="100"
                    style="width: <?php echo round($fileArr[2] / $sum * 100); ?>%">
                    <?php echo round($fileArr[2] / $sum * 100); ?>%
                </div>
            </div>
            <h4>JQuery（<span>
            ...
            <div class="progress">
                <div class="progress-bar progress-bar-striped active" role="progressbar"
                    aria-valuenow="<?php echo round($fileArr[3] / $sum * 100); ?>50" aria-valuemin="0" aria-valuemax="100"
                    style="width: <?php echo round($fileArr[3] / $sum * 100); ?>%">
                    <?php echo round($fileArr[3] / $sum * 100); ?>%
                </div>
            </div>
            <h4>Bootstrap（<span>
            ...
            <div class="progress">
                <div class="progress-bar progress-bar-striped active" role="progressbar"
                    aria-valuenow="<?php echo round($fileArr[4] / $sum * 100); ?>" aria-valuemin="0" aria-valuemax="100"
                    style="width: <?php echo round($fileArr[4] / $sum * 100); ?>%">
                    <?php echo round($fileArr[4] / $sum * 100); ?>%
                </div>
            </div>
            <h4>Angular（<span>
            ...
            <div class="progress">
                <div class="progress-bar progress-bar-striped active" role="progressbar"
                    aria-valuenow="<?php echo round($fileArr[5] / $sum * 100); ?>" aria-valuemin="0" aria-valuemax="100"
                    style="width: <?php echo round($fileArr[5] / $sum * 100); ?>%">
                    <?php echo round($fileArr[5] / $sum * 100); ?>%
                </div>
            </div>
            <h4>H5高级课程（<span>
            ...
            <div class="progress">
                <div class="progress-bar progress-bar-striped active" role="progressbar"
                    aria-valuenow="<?php echo round($fileArr[6] / $sum * 100); ?>" aria-valuemin="0" aria-valuemax="100"
                    style="width: <?php echo round($fileArr[6] / $sum * 100); ?>%">
                    <?php echo round($fileArr[6] / $sum * 100); ?>%
                </div>
            </div>
        </div>
        ...
        btn1.onclick = function () {
            for (var i = 0; i < 7; i++) {
                if (optionsRadios[i].checked) {
                    ajax('php/dovote.php', optionsRadios[i].value);
                    // 禁用所有单选按钮
                    for (var j = 0; j < optionsRadios.length; j++) {
                        optionsRadios[j].disabled = true;
                    }
                    // 禁用投票按钮
                    btn1.disabled = true;
                    break;
